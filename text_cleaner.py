...
DEFAULT_CONFIG = {
    ...
    "paragraph_disallow_patterns": [
        ...
        # This new pattern identifies unlabeled endnotes or bibliography entries.
        # It looks for paragraphs that start with a number (e.g., "1.") and also contain
        # common citation markers like a year, a page reference, "ibid.", or a publisher location.
