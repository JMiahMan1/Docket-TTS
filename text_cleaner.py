    ...
    for start_pattern, end_patterns in config["section_markers"].items():
        try:
            ...
            for start_match in reversed(matches):
                ...
                # Case 1: The rule is to delete everything to the end of the document (e.g., for "Index").
                ...
                # Case 2: The rule has specific end patterns to look for (e.g., for "Dedication").
